...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/strongway/Downloads/stress/stress_search_lastrun.py',
...
text_1 = visual.TextStim(win=win, name='text_1',
    text='In this search experiment, you will see a cue and search display. The cue display consists of a fixation cross and a line pointing in one direction, which you should ignore. Below is an example of a cue display. \n',
    font='Arial',
...
image_instr1 = visual.ImageStim(
    ...
    ori=0.0, pos=(0, 0), size=(10, 7.7),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
text_intro = visual.TextStim(win=win, name='text_intro',
    text='Immediately following the cue display, you will see a visual search display comprising six items. In some trials, one may be a pop-out colour, a distractor you should ignore. \n\nYour task is to find the diamond item and discriminate the orientation of the line inside it. \n',
    font='Arial',
    units='deg', pos=(0, 6), height=1.0, wrapWidth=40.0, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
key_f = visual.TextStim(win=win, name='key_f',
    text='f',
    font='Arial',
    pos=(-4, -4), height=2.0, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-6.0);
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if search_response.status == STARTED and not waitOnFlip:
            theseKeys = search_response.getKeys(keyList=['f','j'], waitRelease=False)
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    block_breakComponents = [block_info, key_resp_2]
    ...
    while continueRoutine:
        ...
        if key_resp_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > key_resp_2.tStartRefresh + key_dur-frameTolerance:
                # keep track of stop time/frame for later
